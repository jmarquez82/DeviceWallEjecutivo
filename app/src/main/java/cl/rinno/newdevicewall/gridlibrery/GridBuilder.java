...
import cl.rinno.newdevicewall.gridlibrery.calculator.PositionCalculator;
import cl.rinno.newdevicewall.gridlibrery.listener.OnItemClickListener;
import cl.rinno.newdevicewall.gridlibrery.listener.OnItemSelectedListener;
import cl.rinno.newdevicewall.gridlibrery.listener.OnViewCreateCallBack;
import cl.rinno.newdevicewall.gridlibrery.utils.BitmapUtils;
...
public class GridBuilder implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    private GridBuilder addItem(GridItem gridItem) {
        ...
        if (mGridLayout.getChildCount() == 0 && gridItem == mGridItemList.get(0)) {
            itemLayout.setTag("Todo menos eso :)");
        }
