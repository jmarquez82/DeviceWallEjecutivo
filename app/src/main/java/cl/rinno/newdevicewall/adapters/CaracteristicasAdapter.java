...
public class CaracteristicasAdapter extends RecyclerView.Adapter<CaracteristicasAdapter.CaracteristicasViewHolder>{

    ArrayList<String> caracteristicasList;

    public CaracteristicasAdapter(ArrayList<String> caracteristicasList) {
    ...
    public CaracteristicasViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_caracteristicas,parent,false);
    ...
    public static class CaracteristicasViewHolder extends RecyclerView.ViewHolder {
        ...
        public CaracteristicasViewHolder(View itemView) {
            super(itemView);
            txtCaracteristica = (TextView) itemView.findViewById(R.id.tv_caracteristicas);
        }
    }
}
